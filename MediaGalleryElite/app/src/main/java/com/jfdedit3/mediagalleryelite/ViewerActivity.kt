...
import com.jfdedit3.mediagalleryelite.databinding.ActivityViewerBinding
...
class ViewerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fullscreenButton.setOnClickListener { toggleChrome() }
    ...
    private fun toggleChrome() {
        val visible = binding.actionRow.visibility == View.VISIBLE
        binding.actionRow.visibility = if (visible) View.GONE else View.VISIBLE
