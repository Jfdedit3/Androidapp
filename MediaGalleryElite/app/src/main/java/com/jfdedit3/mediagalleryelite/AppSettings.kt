...
class AppSettings(context: Context) {
    private val prefs = context.getSharedPreferences("elite_settings", Context.MODE_PRIVATE)
    ...
    var sortMode: SortMode
        get() = SortMode.valueOf(prefs.getString("sort_mode", SortMode.DATE_DESC.name) ?: SortMode.DATE_DESC.name)
